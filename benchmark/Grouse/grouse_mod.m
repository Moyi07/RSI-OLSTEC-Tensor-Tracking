...
% Modified by H.Kasai on June 07, 2017
    ...
    for outiter = 1 : maxCycles
        ...
        stop_cost = grouse_select_early_stop_cost(early_stop_on, train_cost, causal_train_cost);
...
function stop_cost = grouse_select_early_stop_cost(mode, global_train_cost, causal_train_cost)
    ...
    switch mode
        ...
        otherwise
            error('grouse_mod:InvalidEarlyStopMode', ...
