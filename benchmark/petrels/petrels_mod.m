...
% Created by H.Kasai on June 07, 2017
    ...
    for outiter = 1 : maxepochs
        ...
        for k= 1 : numc
            ...
            % Recalculate weights using the updated subspace.
            U_Omega = U(idx,:);
            weights = pinv(U_Omega)*v_Omega;
        ...
        stop_cost = petrels_select_early_stop_cost(early_stop_on, train_cost, causal_train_cost);
...
function stop_cost = petrels_select_early_stop_cost(mode, global_train_cost, causal_train_cost)
    ...
    switch mode
        ...
        otherwise
            error('petrels_mod:InvalidEarlyStopMode', ...
